...
func (flows *TSNFlows) Show_Stream() {
...
func (flows *CANFlows) Show_Stream() {
...
func (flows *TSNFlows) Show_Flows() {
	// Display all flows.
...
func (flows *CANFlows) Show_Flows() {
	// Display all flows.
